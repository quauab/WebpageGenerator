...
public abstract class CustomClass {
	...
	protected static void error(Exception exception) {
		String cause = null;
		String message = exception.getLocalizedMessage().toString();
		if (null != (cause = exception.getCause().toString())) {
			message += "\nCause:\t" + cause;
		} else {
			message += "\nCause:\tUnknown";
		}
	...
	protected final static javax.swing.ImageIcon icon = createImageIcon("/app_icon.gif");
	...
	protected static javax.swing.ImageIcon createImageIcon(String path) {
		...
		if (imgURL != null) {
			...
			try {
				return new ImageIcon("/medium.gif");
	...
	protected final static class FsConstants {
